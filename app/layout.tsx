...
export const metadata: Metadata = {
  title: "AutoPrompt Kit | Premium Prompt Packs for Autonomous AI Agents",
  description:
    "AutoPrompt Kit is a premium digital product with battle-tested prompt packs for Hermes, Nemotron, Claude, Cursor, Grok, and more.",
